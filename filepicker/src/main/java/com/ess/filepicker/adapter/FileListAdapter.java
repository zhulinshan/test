...
public class FileListAdapter extends BaseQuickAdapter<EssFile, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, EssFile item) {
        ...
        CheckBox checkBox = helper.getView(R.id.checkbox_item_file_list);
        if (item.isDirectory()) {
        ...
        if(item.isChecked()){
            checkBox.setBackgroundResource(R.drawable.iv_checkbox_checked);
//            helper.setVisible(R.id.checkbox_item_file_list,true);
        }else {
            checkBox.setBackgroundResource(R.drawable.iv_checkbox_normal);
...
//            helper.setVisible(R.id.checkbox_item_file_list,false);
        ...
        switch (fileNameExtension) {
            ...
            case "doc":
            case "docx":
                imageView.setImageResource(R.mipmap.iv_word);
                break;
            case "exe":
            ...
            case "f4v":
                ...
                break;
            case "pdf":
                imageView.setImageResource(R.mipmap.iv_pdf);
                break;
            case "ppt":
            case "pptx":
            ...
            case "xls":
            case "xlsx":
                imageView.setImageResource(R.mipmap.iv_xls);
                break;
            case "zip":
                imageView.setImageResource(R.mipmap.iv_zip);
                break;
            case "rar":
                imageView.setImageResource(R.mipmap.iv_rar);
                break;
            case "ext":
            default:
                if (item.isDirectory()) {
