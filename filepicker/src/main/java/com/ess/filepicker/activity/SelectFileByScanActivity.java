...
public class SelectFileByScanActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initUi() {
        ...
        btn_select = findViewById(R.id.select_file_btn_selected);
...
//        mCountMenuItem.setTitle(String.format(getString(R.string.selected_file_count), String.valueOf(mSelectedFileList.size()), String.valueOf(SelectOptions.getInstance().maxCount)));
        btn_select.setText(String.format(getString(R.string.selected_file_count), String.valueOf(mSelectedFileList.size()), String.valueOf(SelectOptions.getInstance().maxCount)));
        if (mSelectedFileList.size() > 0){
            btn_select.setBackgroundResource(R.color.green);
        }else{
            btn_select.setBackgroundResource(R.color.selected_bg_color);
        }
